...
pub(crate) fn fix_rust_log_if_not_set() {
...
pub(crate) fn create_server(context: Context) -> Server<Context> {
...
pub(crate) fn add_mfo_api_routes_to_server(mut api: Server<Context>) -> Server<Context> {
